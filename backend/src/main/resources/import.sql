...
INSERT INTO tb_project (owner_id, name, description, start_date, deadline, status, progress, created_at) VALUES (2, 'Landing Page Salão de Beleza Z', 'Landing Page para o salão de beleza Z de São Caetano do Sul', '2023-02-08', '2024-02-08', 'NOT_STARTED', 56, NOW());
